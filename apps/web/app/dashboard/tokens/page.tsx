...
type DashboardTokensPageProps = {
  searchParams: Promise<{ viewAs?: string }>;
};

export default async function DashboardTokensPage({ searchParams }: DashboardTokensPageProps) {
  const sessionActor = await requireSessionActor("/dashboard/tokens");
